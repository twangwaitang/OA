                ...
                if(data){
                    ...
                    for (var i = 1; i<=data.question_answer.length; i++){
                        ...
                        var html =' <div class="form-group">'+
                            ...
                            '<input type="radio" name="question_edit_answer" id="'+alphabet+'"  value="'+alphabet+'"> '+alphabet+'】 </label></div>';
                    ...
                    $(":radio[name='question_edit_answer'][value='" + data.answer + "']").prop("checked", "checked");
                } else{
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        'answer': $("input[name='question_edit_answer']:checked").val(),
                        'type':0,
   ...
   //添加更多
    $('#more_options').click(function () {
        ...
        var html =' <div class="form-group">'+
            '<textarea id='+ckid+' cols="20" rows="1" class="ckeditor" placeholder="请输入选项'+alphabet+'..." ></textarea>'+
            '<label class="checkbox-inline" style="font-size: 16px;color: #0a6aa1;">【选项'+
            '<input type="radio" name="question_answer" id="'+alphabet+'"  value="'+alphabet+'"> '+alphabet+'】 </label></div>';
        $(html).appendTo('#answer_options');
        CKEDITOR.replace(ckid,{toolbar:'Short',height:'100px'});
    })
    //保存按钮
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        'answer': $("input[name='question_answer']:checked").val(),
                        'question_answer': anwserArray
                    },
                    beforeSend : function ()
                    {
