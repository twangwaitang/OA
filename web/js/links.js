...
var table =  $('#users'),
    linksEditModal = $('#links_edit_modal'),
    linksAddForm = $('#links_add_form'),
    linksEditForm = $('#links_edit_form'),
...
$(function () {
    ...
    $('#fileupload').fileupload({
        ...
        if (data.result.code){
            ...
            var imgUrl = '../uploads/links/'+data.result.fileName;
